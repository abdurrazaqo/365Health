      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12 md:mb-16 lg:mb-20">
          <a href="#" className="flex items-center mb-6 md:mb-8">
            <h2 className="text-lg font-black tracking-tight"><span className="text-primary">365</span><span className="text-dark-text">Health</span></h2>
          </a>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6 md:gap-8">
            ...
            <div className="flex gap-4 md:gap-6 items-center">
              ...
              <a className="text-primary hover:text-secondary transition-colors" href="https://x.com/365HealthNG" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a className="text-primary hover:text-secondary transition-colors" href="https://linkedin.com/company/365health-systems" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6 md:pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
          <p className="text-[10px] font-bold text-dark-text/30">© 2026 365Health Systems Ltd. All rights reserved.</p>
