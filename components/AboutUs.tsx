    ...
    <section id="about" className="py-16 md:py-24 lg:py-32 px-6 md:px-12 lg:px-16 bg-white" ref={sectionRef}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
          <h2 className="text-3xl md:text-4xl font-black tracking-tight text-dark-text leading-tight">About <span className="text-primary font-serif">365Health Systems</span></h2>
